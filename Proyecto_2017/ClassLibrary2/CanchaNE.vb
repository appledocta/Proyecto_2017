...
Public Class CanchaNE
    ...
    End Sub
    Public Sub New(ByVal id_cancha As Integer, ByVal habilitado As Integer, ByVal precio_cancha As Double, ByVal fechaActPrecio As DateTime, ByVal descripcion As String)
